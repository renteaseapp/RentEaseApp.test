            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <AdminFeatureCard
                  ...
                  description="Handle user complaints and dispute resolution"
                  linkTo={ROUTE_PATHS.ADMIN_MANAGE_CLAIMS}
                />
                <AdminFeatureCard
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="font-medium">{t('viewUsers')}</span>
                             ...
                             <Link
                 to={ROUTE_PATHS.ADMIN_MANAGE_CLAIMS}
                 className="flex items-center gap-3 p-4 bg-white/20 rounded-xl hover:bg-white/30 transition-all duration-300"
               >
                 <FaExclamationTriangle className="h-5 w-5" />
                 <span className="font-medium">{t('handleComplaints')}</span>
               </Link>
              <Link
